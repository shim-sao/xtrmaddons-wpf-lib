...
namespace XtrmAddons.Net.Windows.Converter.Picture
{
    ...
    /// </summary>
    public class ConverterExtractLargeIconFromDirectory : IValueConverter
    {
        /// <summary>
        /// Method to convert string path of the Directory into bitmap image. 
        /// </summary>
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return ShellEx.GetBitmapFromFolderPath((string)value, size).ToBitmapImage();
        }

        /// <summary>
        /// Method to convert bitmap image into string Directory of the file. 
        /// </summary>
        /// <param name="value">The binding object path of the picture.</param>
        /// <param name="targetType">The target type for binding.</param>
        /// <param name="parameter">Parameter for convert.</param>
